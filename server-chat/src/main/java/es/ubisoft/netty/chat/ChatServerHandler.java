...
public class ChatServerHandler extends SimpleChannelInboundHandler<String> {
	...
	private static final String GENERAL_ROOM_NAME = "general room";
	...
	public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
		...
		ChatUser newUser = new ChatUser(inconming, incomingAutoName, chatRooms.get(GENERAL_ROOM_NAME));
		...
		newUser.getChatRoom().incrementActiveMessageCounter();
	...
	public void joinGroupHandler(ChatRoom incomingChannelGroup, ChatUser incoming, String newRoomName) {
		...
		incoming.getChatRoom().incrementActiveMessageCounter();
